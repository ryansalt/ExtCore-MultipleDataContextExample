...
namespace WebApplication.ExtensionA.Actions
{
	/// <summary>
	...
	public class AddStorageAction : IConfigureServicesAction
	{
		...
		/// <summary>
		/// Registers found implementation of the <see cref="IStorage{T}">IStorage</see> interface inside the DI.
		/// </summary>
		...
		{
			services.AddScoped(typeof(ExtCore.Data.Abstractions.IStorageContext<FirstStorageContext>), typeof(ExtCore.Data.EntityFramework.Sqlite.StorageContext<FirstStorageContext>));
			services.AddScoped(typeof(ExtCore.Data.Abstractions.IStorage<FirstStorageContext>), typeof(Storage<FirstStorageContext>));
		}
	}
}
