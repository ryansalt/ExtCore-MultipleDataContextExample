...
namespace ExtCore.Data.EntityFramework
{
	...
	public abstract class DesignTimeStorageContextFactoryBase<T, TT> : IDesignTimeDbContextFactory<T> where T : StorageContextBase<TT> where TT: class
    {
    /// <summary>
    ...
    {
      return DesignTimeStorageContextFactoryBase<T, TT>.StorageContext;
    }
    ...
    {
      DesignTimeStorageContextFactoryBase<T, TT>.StorageContext = serviceProvider.GetService<IStorageContext<TT>>() as T;
    }
  }
}