...
namespace ExtCore.Data.Dapper
{
  ...
  public abstract class RepositoryBase<TEntity, TContext> : IRepository<TContext> where TEntity : class where TContext : class, IEntity
  {
    protected IStorageContext<TContext> storageContext;
